...
public class DinnerEventDemo {
	...
	public static void main(String[] args) {
		...
		//declare variables needed to form Dinner Event
		String eventNum;
		int guestNum;
		int entree;
		int side1;
		...
		// Declare 4 DinnerEvent objects
		DinnerEvent[] d = new DinnerEvent[4];
		
		//create 4 DinnerEvent objects
		for (int i = 0; i < d.length; i++) {
			...
			side2 = setSidesTwo();
			dessert = setDessert();
			d[i] = new DinnerEvent(eventNum, guestNum, entree, side1, side2, dessert, eventType);
			d[i].getMenu();
		}
		sortOptions();
